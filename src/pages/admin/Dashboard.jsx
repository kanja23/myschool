...
export default function AdminDashboard() {
  ...
  // Show setup wizard if school hasn't completed setup yet
  ...
  return (
    <DashboardLayout navItems={nav} title="School Admin">
      <Routes>
        ...
        <Route path="schemes"     element={<ComingSoon label="Teaching Plans" phase="4" />} />
        <Route path="assessments" element={<ComingSoon label="Assessments" phase="5" />} />
